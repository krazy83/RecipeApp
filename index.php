		...
		<div class="wrap clearfix">
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					...
					<li><a href="pantry.html" title="Features"><span>Pantry</span></a>
					</li>
					...
					<div class="one-fourth wow fadeInDown" data-wow-delay=".5s">
						<div class="widget container">
							<div class="textwrap">
								...
								<p>All you need to do is enter an igredient</p>
					...
					<div class="cwrap">
						...
						<div class="entries row">
							...
							<div class="entry one-third wow fadeInLeft" data-wow-delay=".8s">
								...
								<div class="container">
									<h2><a href="recipe.html">Sushi mania: this is the best sushi ever</a></h2> 
									<div class="actions">
										<div>
											<div class="difficulty"><i class="ico i-easy"></i><a href="#">easy</a></div>
											<div class="likes"><i class="ico i-likes"></i><a href="#">10</a></div>
